...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("Cần phải tag 1 người bạn muốn chửi lad máy", event.threadID);
...
setTimeout(() => {a({body: "ĐỊT MẸẸẸẸẸẸẸẸẸẸ MÀY!!!" + " " + name, mentions: arraytag})} , 80000);
    }
