...
module.exports.run = async ({ event, api, args }) => {
  ...
  try {
    ...
    const background = await Canvas.loadImage("https://chiase24.com/wp-content/uploads/2019/06/Tuy%E1%BB%83n-t%E1%BA%ADp-h%C3%ACnh-n%E1%BB%81n-4K-d%C3%A0nh-cho-m%C3%A1y-t%C3%ADnh-%C4%91%E1%BA%B9p-16.jpg");
   ...
   Canvas.registerFont(__dirname+"/cache/fontfamily.ttf", {
    ...
    //ctx.beginPath();
    console.log(chalk.green("Chuyển đổi sang bộ nhớ đệm ..."));
