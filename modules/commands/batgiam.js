...
module.exports.config = {
    ...
    version: "2.0.0",
    hasPermssion: 0,
    credits: "ProCoderMew - Đ.V Bằng FIX",
    description: "",
...
async function makeImage({ one, two }) {
    ...
    let getAvatarOne = (await axios.get(`https://graph.facebook.com/${one}/picture?height=100&width=100&access_token=170440784240186|bc82258eaaf93ee5b9f577a8d401bfc9`, { responseType: 'arraybuffer' })).data;
    fs.writeFileSync(avatarOne, Buffer.from(getAvatarOne, 'utf-8'));
    
    let getAvatarTwo = (await axios.get(`https://graph.facebook.com/${two}/picture?height=100&width=100&access_token=170440784240186|bc82258eaaf93ee5b9f577a8d401bfc9`, { responseType: 'arraybuffer' })).data;
